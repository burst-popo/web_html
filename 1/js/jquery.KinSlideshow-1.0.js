...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		...
		btn:{btn_bgColor:"url(img/imgflow.png) no-repeat -14px -14px",btn_bgHoverColor:"url(img/imgflow.png) no-repeat -38px -14px"}//btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#000000",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:1,btn_bgAlpha:0.7} //按钮样式设置，(isHasBtn = true 前提下启用)
	  },settings);
	  var titleBar_Bak = {titleBar_height:40,titleBar_bgColor:"#000000",titleBar_alpha:0.5}
	  var titleFont_Bak = {TitleFont_size:12,TitleFont_color:"#FFFFFF",TitleFont_family:"Verdana",TitleFont_weight:"bold"}
	  var btn_Bak = {btn_bgColor:"url(img/imgflow.png) no-repeat -14px -14px",btn_bgHoverColor:"url(img/imgflow.png) no-repeat -38px -14px"}//,btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#000000",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:1,btn_bgAlpha:0.7} //按钮样式设置，(isHasBtn = true 前提下启用)
	 ...
	 function KinSlideshow_setBtn(){
		 ...
		 if(settings.isHasBtn && KinSlideshow_imgaeLength >= 2){
			 $(KinSlideshow_BoxObject).append("<div class='KinSlideshow_btnBox' style='position:absolute;left:10px;bottom:5px; z-index:100'></div>");
