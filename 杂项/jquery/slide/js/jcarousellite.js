...
$.fn.jCarouselLite = function(o) {
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
        ...
        if(o.auto)
            var tp=self.setInterval(function() {
                go(curr+o.scroll);
            }, o.auto+o.speed);
			ul.hover(function(){clearInterval(tp);},function(){tp=setInterval(function() {go(curr+o.scroll);}, o.auto+o.speed);});
